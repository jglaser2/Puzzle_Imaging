...
num=3; %number of simulations -- (used for test==1 and test==2)
vox_size_vec=5:6;%2:10; %Vector of size of voxels to test (average side lengths in um)
num_vox_removed=0;
...
num=3; %number of simulations -- (used for test==1 and test==2)
vox_size=5; 
perc_vox_removed_vec=.85:.05:.9;%[0:.05:.9]; %Vector of percentages of voxels removed to test -- (used for test==2
